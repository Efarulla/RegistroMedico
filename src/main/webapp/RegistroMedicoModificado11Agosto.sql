...
CREATE TABLE HISTORICO_ATLETA ( 
CODICO_HIST_ATLETA INT PRIMARY KEY NOT NULL 
GENERATED ALWAYS AS IDENTITY
(START WITH 1,INCREMENT BY 1),
CODIGO_ATLETA INT NOT NULL, 
CEDULA_A INT NOT NULL,
...
CODIGO_HIST_MEDICO INT PRIMARY KEY NOT NULL 
GENERATED ALWAYS AS IDENTITY
(START WITH 1,INCREMENT BY 1), 
CODIGO_MEDICO INT NOT NULL, 
CEDULA_M INT NOT NULL,
...
CODIGO_HIST_CONSULTA INT PRIMARY KEY NOT NULL 
GENERATED ALWAYS AS IDENTITY
(START WITH 1,INCREMENT BY 1),
CODIGO_CONSULTA INT NOT NULL, 
ALERGIA_C VARCHAR (80),
...
INSERT INTO USUARIO (ROL,NOMBRE_U,APELLIDO_U,CORREO_U,PASSWORD_1,PASSWORD_2,ACTIVO)
VALUES(1,'Eduardo','Farulla','efarulla@hotmail.com','eduardo','eduardo',true),
      (2,'Castillo','Picado','santicastillop@gmail.com','santiago','santiago',true),
      (3,'ugalde','Guzman','efarulla@hotmail.com','orlando','orlando',true);
...
INSERT INTO EXPEDIENTE (FECHA_E,CODIGO_CONSULTA)
VALUES('2020-04-20',1);